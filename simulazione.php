<?php
	...
	if (!isset($_SESSION['authuser']))
		{
			echo '<script type="text/javascript">alert("Autorizzazione negata! Pagina protetta da accesso!");</script>';
			echo "<script language='javascript'>window.location.href='../trattativa';</script>";	
			exit;
		} else {
    ...
    <div id="contenuto">   
        ...
        <form class="well form-horizontal" method="post" id="contact_form">
            ...
            <div class="form-group">
              <label class="col-md-9 control-label">Cod. Documento</label>  
                ...
                <div class="input-group">
                    <span id="recupero" onClick="caricaDoc();" role="button" title="Dopo aver indicato un documento valido, cliccare qui per caricare i dati" class="input-group-addon"><i class="glyphicon glyphicon-tags"></i></span>
              <input id="id_simulazione" name="id_simulazione" placeholder="Codice" class="form-control" type="text" maxlength="9" value="<?php echo $nuovo_id; ?>"  onkeypress="return soloLettereMaiuscENumeri(event);">
                </div>
              </div>
            </div><br>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
              <input id="eta" class="form-control"  type="text" maxlength="2" onkeypress="return soloNumeri(event);">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input id="percdecum" class="form-control"  type="text" value="5.0" maxlength="4" onkeypress="return soloPercentuali(event);">
                </div>
              </div>
              <label class="col-md-3 control-label">% Interesse Decumulo</label>  
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-pushpin"></i></span>
              <input id="percinterdecum" class="form-control" type="text" value="2.5" maxlength="4" onkeypress="return soloPercentuali(event);">
                </div>
              </div>
              <label class="col-md-1 control-label">Scadenza</label>  
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
              <input id="etascadenza" class="form-control" type="text" maxlength="2" onkeypress="return soloNumeri(event);">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">Importo Decumulo</label>  
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-pushpin"></i></span>
              <input id="importodecum" name="importodecum" class="form-control"  type="text" value="0.00" maxlength="12" onkeypress="return soloValuta(event);" onChange="ElaboraImpPerc('importo');">
                </div>
              </div><!--
                <div class="col-md-1">
            ...
            <div class="form-group">
              ...
              <div class="col-md-1">
                <button type="button" id="salva" name="salva" class="btn btn-warning btn-lg" title="Cliccare per salvare i dati">Salva <span class="glyphicon glyphicon-floppy-disk"></span></button>
              </div>
              <label class="col-md-3 control-label"></label>
              <div class="col-md-1">
                <button type="button" id="anteprima" name="anteprima" class="btn btn-info btn-lg" title="Cliccare per visualizzare i dati in anteprima">Anteprima <span class="glyphicon glyphicon-zoom-in"></span></button>
              </div>
              <label class="col-md-2 control-label"></label>
              <div class="col-md-1">
                <button type="button" id="sviluppa" name="sviluppa" class="btn btn-info btn-lg" title="Cliccare per inviare i dati via email al cliente">Invia Email <span class="glyphicon glyphicon-envelope"></span></button>
              </div>
            </div>
